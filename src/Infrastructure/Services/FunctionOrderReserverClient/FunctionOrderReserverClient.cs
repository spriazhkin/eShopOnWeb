...
{
    public class FunctionOrderReserverClient : IOrderReserver
    {
        private readonly FunctionOrderReserverClientConfiguration _configuration;
        private readonly RestClient _restClient;

        public FunctionOrderReserverClient(IOptions<FunctionOrderReserverClientConfiguration> configuration)
        {
